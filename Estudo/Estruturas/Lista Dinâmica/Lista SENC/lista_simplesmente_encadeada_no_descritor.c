...
#include <stdlib.h>
#include <string.h>
#include "lista_simplesmente_encadeada_no_descritor.h"
...
int lista_vazia(lista * list) {
    ...
    if(list->inicio == NULL) return VERDADEIRO;
    else return FALSO;
}
